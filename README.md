the code for the Adaptive Preconditioned Conjugate Gradient Regularization (APCGR) Algorithm with Sigmoid Function (SF) Constraint into the focusing inversion，A detailed description is provided below:
